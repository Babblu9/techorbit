...
export const metadata = {
    title: 'Job Courses | Job Oriented Programs | Techorbit',
    description: 'Job oriented courses in Hyderabad. Learn industry skills and get placed with our comprehensive job training programs.',
};

export default function JobBatchesPage() {
    return (
        <div className={styles.pageWrapper}>
            {/* Hero Section */}
            <section className={styles.hero}>
                <h1 className={styles.title}>Job Courses</h1>
                <p className={styles.subtitle}>Job Oriented Programs - Learn, Practice, Get Placed</p>
            </section>
